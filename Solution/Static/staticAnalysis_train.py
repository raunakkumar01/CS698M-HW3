...
def preprocessData():
	...
	a = pd.read_excel("StaticAnalysis.xlt")
	x = np.array(a.iloc[:, 2:153])
	# print(x)
...
c = 6
# for c in c_value:
clf = SVC(C = c,gamma = "scale") # # c =6   0.9714% best
clf = clf.fit(train_x,train_y)
y_pred = clf.predict(test_x)
print("svm after PCA at C =:",c)
print("accuracy_score: ",accuracy_score(test_y,y_pred))
print("precision_score: ",precision_score(test_y,y_pred))
print('recall_score: ',recall_score(test_y,y_pred))
print(confusion_matrix(test_y, y_pred))
...
c = 17
# for c in c_value:
clf = LogisticRegression(C = c, solver = "liblinear") # best at c =17
clf = clf.fit(train_x,train_y)
y_pred = clf.predict(test_x)
print("Logistic regression after PCA at c:",c)
print("accuracy_score: ",accuracy_score(test_y,y_pred))
print("precision_score: ",precision_score(test_y,y_pred))
print('recall_score: ',recall_score(test_y,y_pred))
print(confusion_matrix(test_y, y_pred))
